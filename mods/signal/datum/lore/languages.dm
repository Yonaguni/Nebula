...
/decl/language/belter/scramble(var/input) //mate
	. = ..()
...
/decl/language/cephlapoda
	...
	speech_sounds = list(
		'mods/signal/sound/cephlapod/warble1.ogg',
		'mods/signal/sound/cephlapod/warble2.ogg',
		'mods/signal/sound/cephlapod/warble3.ogg',
		'mods/signal/sound/cephlapod/warble4.ogg',
		'mods/signal/sound/cephlapod/warble5.ogg',
		'mods/signal/sound/cephlapod/warble6.ogg',
		'mods/signal/sound/cephlapod/warble7.ogg',
		'mods/signal/sound/cephlapod/warble8.ogg',
		'mods/signal/sound/cephlapod/warble9.ogg',
		'mods/signal/sound/cephlapod/warble10.ogg',
		'mods/signal/sound/cephlapod/warble11.ogg'
	)
